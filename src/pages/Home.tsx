      ...
      <div className="relative pb-0" style={{ backgroundColor: "#1D1D1D" }}>
        ...
        <div className="absolute inset-0 flex justify-center items-center opacity-10 md:hidden pointer-events-none z-0">
          <svg
            ...
            aria-label="Abstract design with a lightbulb symbolizing creativity in product design"
          >
            ...
            />
            {/* Lightbulb shape to symbolize creativity */}
            <path
              d="M280 100C280 90.0589 288.059 82 298 82C307.941 82 316 90.0589 316 100C316 107.732 311.315 114.347 305 117.6V130C305 132.209 303.209 134 301 134H295C292.791 134 291 132.209 291 130V117.6C284.685 114.347 280 107.732 280 100Z"
              fill="white"
            />
            <path
              d="M295 134H301V140C301 142.209 299.209 144 297 144H299C296.791 144 295 142.209 295 140V134Z"
              fill="white"
            />
          </svg>
        </div>
